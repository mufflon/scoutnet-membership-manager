...
from scoutnet_membership_manager.settings import FINGERPRINT_ALGO, FINGERPRINT_CHARS, Mode, Settings

if TYPE_CHECKING:
    from scoutnet_membership_manager.scoutnet.client import FixtureClient, ReadOnlyClient
