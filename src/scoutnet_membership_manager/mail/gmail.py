...
from scoutnet_membership_manager.mail.base import MailMessage, MailSender
...
class GmailMailSender(MailSender):
    ...
    def __init__(self, sending_address: str, credentials_file: str) -> None:
        # Sending mailbox must be inside the Workspace domain (§10).
        self._from = sending_address
        self._credentials_file = credentials_file

    def _service(self) -> Any:  # pragma: no cover - needs google extra
        try:
