...
class Settings(BaseSettings):
    ...
    # The single non-secret config file (scoutnet-membership-manager.json) provides mode,
    ...
    config_path: Path = Path("scoutnet-membership-manager.json")
    ...
    def settings_customise_sources(
        ...
        .env > the scoutnet-membership-manager.json file > file secrets. SCOUTNET_CONFIG_PATH picks
        the file; a missing file simply contributes nothing (the app then infers).
        """
        path = Path(os.environ.get("SCOUTNET_CONFIG_PATH", "scoutnet-membership-manager.json"))
